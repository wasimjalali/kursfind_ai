...
export default function ProviderSidebar({ isOpen = false, onClose, setIsOpen, lang = 'de', setLang }) {
  ...
  // Fetch unread notification count for providers
  useEffect(() => {
    async function fetchNotificationCount() {
      try {
        const res = await fetch('/api/notifications/unread-count?role=provider');
  ...
  useEffect(() => {
    if (pathname === '/provider/dashboard/notifications') {
  ...
  return (
    <>
      ...
      >
        ...
        {/* Footer - Language Selector + Back to Website */}
