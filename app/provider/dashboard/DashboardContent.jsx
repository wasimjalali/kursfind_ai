...
export default function DashboardContent({ provider, courses, stats }) {
  const { labels } = usePortalLanguage();
  const { totalCourses, totalViews, totalClicks, activeCourses, recentCourses } = stats;
    ...
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="bg-gradient-to-r from-cyan-500 to-emerald-500 text-white rounded-xl sm:rounded-2xl p-4 sm:p-8 shadow-lg">
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold mb-1 sm:mb-2">
          {labels.dashboard.welcome}, {provider?.company_name}!
        </h2>
        ...
        <div className="p-4 sm:p-6 border-b border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
            <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900">
              {labels.dashboard.latestCourses}
            </h3>
            <Link 
        ...
        {totalCourses === 0 ? (
          <div className="p-8 sm:p-12 text-center">
            ...
            <h4 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 mb-2">
              {labels.dashboard.noCourses}
            </h4>
            <p className="text-sm sm:text-base text-gray-600 mb-6">
              {labels.dashboard.noCoursesDesc}
            </p>
            <Link
              href="/provider/dashboard/courses/new"
            ...
            >
              ...
              {labels.dashboard.createFirstCourse}
            </Link>
          </div>
        ) : (
