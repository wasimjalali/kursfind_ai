  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-100 to-emerald-100">
      ...
      <div className="pt-6 pl-6 pb-4">
        <Link href="/" className="inline-flex items-center hover:opacity-90 transition-opacity cursor-pointer">
          <Image
      ...
      <div className="flex items-center justify-center px-4 pb-8">
            ...
            {!showWaitlist ? (
              <>
                ...
                <div className="relative my-5">
                  ...
                  <div className="relative flex justify-center text-sm">
                    <span className="px-3 bg-white text-gray-400 text-xs">oder</span>
                  </div>
                </div>
              ...
              <>
                ...
                <div className="flex items-center gap-3 mb-4 pb-4 border-b border-gray-100">
                  ...
                  <div>
                    <h2 className="text-base font-bold text-gray-800">Warteliste beitreten</h2>
                    <p className="text-gray-500 text-xs">
                      Erhalten Sie Ihren Einladungscode per E-Mail
                    </p>
                  </div>
                </div>
                          ...
                          <div className="sp-checkbox-option">
                            <label>
                              <input 
                                ...
                                required 
                              />
                              <span>Ich bestätige, dass ich derzeit in Deutschland lebe.</span>
                          ...
                          <div className="sp-checkbox-option">
                            <label>
                              <input 
                                ...
                                required 
                              />
                              <span>Ich stimme zu, Informationen von Kursfind AI zu erhalten. Abmeldung jederzeit möglich.</span>
                              <span><strong>*</strong></span>
                            </label>
                          </div>
                        </div>
        ...
        <div className="mt-4 text-center space-y-2">
          <p className="text-gray-700 text-xs">
            Bildungsanbieter?{' '}
            <Link href="/anbieter" className="text-cyan-700 hover:text-cyan-800 font-medium cursor-pointer underline">
              Partner werden
            </Link>
          </p>
          <p className="text-gray-600 text-xs">
            <Link href="/impressum" className="hover:text-gray-800 cursor-pointer underline">Impressum</Link>
            {' · '}
            <Link href="/datenschutz" className="hover:text-gray-800 cursor-pointer underline">Datenschutz</Link>
          </p>
        </div>
