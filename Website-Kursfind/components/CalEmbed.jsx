...
/**
 * Cal.com Booking Component for Provider Consultation
 * 
 * USAGE IN NEXT.JS:
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            Partner von Kursfind AI werden
          </h2>
          <p className="text-xl mb-8 opacity-90 max-w-3xl mx-auto">
            Verbinde dich mit motivierten Lernenden mit Bildungsgutschein oder AVGS-Förderung. 
            Tritt noch heute unserem Netzwerk geprüfter Bildungsanbieter bei.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 space-y-6">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <p className="text-sm font-semibold opacity-90">Telefon</p>
            ...
            <div className="pt-6 border-t border-white/20">
              <h4 className="font-semibold mb-3">Was Sie erwartet:</h4>
              <ul className="space-y-2 opacity-90">
                <li className="flex items-start">
                  <span className="mr-2">✓</span>
                  <span>Kostenlose Kurslistung (6-12 Monate)</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">✓</span>
                  <span>KI-gestützte Kursvermittlung</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">✓</span>
                  <span>Nur €50-€120 pro qualifiziertem Lead</span>
                </li>
                <li className="flex items-start">
                  <span className="mr-2">✓</span>
                  <span>Einfaches Onboarding</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-2xl p-6">
            ...
            <p className="text-gray-700 text-center mb-6">
              Buchen Sie ein 30-minütiges Beratungsgespräch
            </p>
